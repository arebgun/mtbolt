...
if not PRODUCTION:
    ...
    DATABASES['default'] = {
        ...
        'NAME': 'mylocaldb3',                      # Or path to database file if using sqlite3.
        'USER': PG_USER,                      # Not used with sqlite3.
        'PASSWORD': PG_PASSWORD,                  # Not used with sqlite3.
        'HOST': '',                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '',                      # Set to empty string for default. Not used with sqlite3.
    }
    STATIC_URL = '/static/'
...
SECRET_KEY = 's-v5u$8tpj@dfo325e1hnz07-pw_gezl%_4*lb53^sxplu_2qg'
...
ROOT_URLCONF = 'mtbolt.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'mtbolt.wsgi.application'
...
BOLT_OBJECT_QUESTIONS_PER_TASK = 5

CORPUS_SIZE = 300
REPRESENTATION_MODEL = 'model1'
