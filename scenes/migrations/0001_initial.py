...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scenes_generateddescription', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='generated_descriptions', to=orm['scenes.Entity'])),
    ...
    models = {
        'scenes.generateddescription': {
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'generated_descriptions'", 'to': "orm['scenes.Entity']"}),
